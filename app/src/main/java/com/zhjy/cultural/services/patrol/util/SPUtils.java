...
public class SPUtils {
    ...
    private synchronized static void init(@NonNull String fileName) {
        ...
        if (fileName.equals(DEFAULT_SP_FILE_NAME))
            spMap.put(fileName, PreferenceManager.getDefaultSharedPreferences(AppContext.getInstance()));
        else
            spMap.put(fileName, AppContext.getInstance().getSharedPreferences(fileName, AppContext.MODE_PRIVATE));
