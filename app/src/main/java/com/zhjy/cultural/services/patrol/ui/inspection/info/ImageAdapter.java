...
public class ImageAdapter extends RecyclerView.Adapter {
    ...
    public ImageAdapter(FragmentManager fragmentManager, OnImageClickListener mListener ) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ImageItem(layoutInflater.inflate(R.layout.activity_feed_back_list_item, parent, false),mListener);
    }
