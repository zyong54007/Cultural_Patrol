...
public class MainListAdapterForWenWu extends RecyclerView.Adapter  {
    ...
    public MainListAdapterForWenWu(FragmentManager fragmentManager) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new MainListTypeItemOfWw(layoutInflater.inflate(R.layout.main_item_list_item_ww, parent, false));
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        MainListTypeItemOfWw item = (MainListTypeItemOfWw) holder;
