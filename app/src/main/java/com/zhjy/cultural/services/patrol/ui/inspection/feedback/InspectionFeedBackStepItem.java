...
import com.zhjy.cultural.services.patrol.databinding.ActivityInspectionFeedBackStepItemBinding;
...
public class InspectionFeedBackStepItem extends RecyclerView.ViewHolder implements View.OnClickListener{

    ActivityInspectionFeedBackStepItemBinding binding;

    public int position;

    public final static String [] stepInfo = {"异常记录","领导反馈","反馈处理","完毕归档"};

    InspectionFeedBackStepItem(View itemView) {
        super(itemView);
