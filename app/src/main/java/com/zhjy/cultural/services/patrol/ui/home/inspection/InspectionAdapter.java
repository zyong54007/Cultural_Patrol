...
public class InspectionAdapter  extends RecyclerView.Adapter{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new InspectionTypeItem(layoutInflater.inflate(R.layout.fragment_main_inspection_list_item, parent, false));
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof InspectionTypeItem) {
            InspectionTypeItem item = (InspectionTypeItem) holder;
