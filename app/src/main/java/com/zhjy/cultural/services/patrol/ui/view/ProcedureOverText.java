...
public class ProcedureOverText extends View {
    ...
    public ProcedureOverText(Context context) {
        super(context);
    }

    public ProcedureOverText(Context context, AttributeSet attrs) {
        super(context);
        mPaint = new Paint();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int width = getWidth() / 2  - mBound.width() / 2 ;
