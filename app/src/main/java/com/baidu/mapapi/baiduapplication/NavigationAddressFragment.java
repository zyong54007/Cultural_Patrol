...
public class NavigationAddressFragment extends Fragment implements BaiduMap.OnMapClickListener,
OnGetRoutePlanResultListener,OnGetGeoCoderResultListener {
	...
	public static NavigationAddressFragment newInstance(MapFragment mActivity, SecondBean bean) {
		NavigationAddressFragment instance = new NavigationAddressFragment();
