...
/**
 * The default_iv view for a ClusterManager. Markers are animated in and out of clusters.
 */
public class DefaultClusterRenderer<T extends ClusterItem> implements
    ...
    /**
     * Gets the "bucket" for a particular cluster. By default_iv, uses the number of points within the
     ...
     * The default_iv implementation draws a circle with a rough count of the number of items.
     */
